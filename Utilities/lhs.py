"""
Code stolen from pyDOE. Removes requirement of installing the whole pyDOE package.
...
def lhs(n, samples=None, criterion=None, iterations=None, lb=None, ub=None):
    """
    ...
    iterations : int
        ...
        (Default: 5).
    lb : list
        Lower bounds to scale the data
    ub : list
        Upper bounds to scale the data
